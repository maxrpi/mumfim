#include "PropertyEvaluationAnalysis.h"
#include "StepperFactory.h"
mumfim::PropertyEvaluationAnalysis::PropertyEvaluationAnalysis(
    apf::Mesh * mesh,
...
mumfim::PropertyEvaluationAnalysis::run(){
  analysis_step_->Assemble();
  analysis_step_->FormReducedStiffnessMatrix();
  analysis_step_->AssembleEffectiveKappa();
  std::cout << analysis_step_->getEffectiveKappa() << "\n";
}